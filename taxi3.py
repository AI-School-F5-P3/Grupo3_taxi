# añadimos sistema de logs en el código del taxímetro con la librería "logging"
import time
import logging
    ...
    if cambiar_tarifas in ['sí', 'si']:
        while True:
            try:
                ...
                break  # Salir del bucle si las tarifas se ingresaron correctamente
            except ValueError:
